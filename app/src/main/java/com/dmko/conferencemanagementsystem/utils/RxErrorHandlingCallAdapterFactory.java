    ...
    private static class RxCallAdapterWrapper implements CallAdapter {
        ...
        private RetrofitException asRetrofitException(Throwable throwable) {
            if (throwable instanceof HttpException) {
                Timber.tag(LOG_NET);
                Timber.i("Converting HttpException to RetrofitException");
            ...
            if (throwable instanceof IOException) {
                Timber.tag(LOG_NET);
                Timber.i("Converting IOException to RetrofitException");

                return RetrofitException.networkError((IOException) throwable);
            }

            Timber.tag(LOG_NET);
            Timber.w("Converting Unexpected exception to RetrofitException");
